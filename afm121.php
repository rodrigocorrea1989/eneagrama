...
<div class="card">
  <div class="card-body">
    ...
    <center><span>121 de 270</span></center><br>
<form action="afm122.php"  method="POST">
    <center><h3 class="text-dark"><strong>Tiendo a ser una persona solitaria, me cuesta expresar mis emociones.</strong></h3></center><br>
