...
<div class="card">
  <div class="card-body">
    ...
    <center><span>11 de 270</span></center><br>
<form action="afm12.php" method="POST">
    <center><h3 class="text-dark"><strong> Es frecuente que otras personas carezcan de capacidad para comprender mis sentimientos.</strong></h3></center><br>
