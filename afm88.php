...
<div class="card">
  <div class="card-body">
    ...
    <center><span>88 de 270</span></center><br>
<form action="afm89.php" method="POST">
    <center><h3 class="text-dark"><strong>Soy una persona tranquila y pacífica, estoy bien así.</strong></h3></center><br>
