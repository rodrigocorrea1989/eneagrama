...
<div class="card">
  <div class="card-body">
    ...
    <center><span>187 de 270</span></center><br>
<form action="afm188.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelen acusarme de ser una persona depresiva, fatalista, excéntrica, autodestructiva.</strong></h3></center><br>
