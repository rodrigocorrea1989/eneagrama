...
<div class="card">
  <div class="card-body">
    ...
    <center><span>171 de 270</span></center><br>
<form action="afm172.php" method="POST">
    <center><h3 class="text-dark"><strong>Cuando se me pasa el enojo, ni me acuerdo lo que dije.</strong></h3></center><br>
