...
<div class="card">
  <div class="card-body">
    ...
    <center><span>213 de 270</span></center><br>
<form action="afm214.php" method="POST">
    <center><h3 class="text-dark"><strong>Cuando los problemas agobian, lo mejor es no hacer nada.</strong></h3></center><br>
