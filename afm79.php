...
<div class="card">
  <div class="card-body">
    ...
    <center><span>79 de 270</span></center><br>
<form action="afm80.php" method="POST">
    <center><h3 class="text-dark"><strong>Siento orgullo de ser una persona objetiva y clara.</strong></h3></center><br>
