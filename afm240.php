...
<div class="card">
  <div class="card-body">
    ...
    <center><span>240 de 270</span></center><br>
<form action="afm241.php" method="POST">
    <center><h3 class="text-dark"><strong>Cuido muy bien mi dinero y el de los demás.</strong></h3></center><br>
