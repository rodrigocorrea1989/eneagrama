...
<div class="card">
  <div class="card-body">
    ...
    <center><span>235 de 270</span></center><br>
<form action="afm236.php" method="POST">
    <center><h3 class="text-dark"><strong>Me resulta fácil expresar mi insatisfacción.</strong></h3></center><br>
