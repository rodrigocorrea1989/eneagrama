...
<div class="card">
  <div class="card-body">
    ...
    <center><span>73 de 270</span></center><br>
<form action="afm74.php" method="POST">
    <center><h3 class="text-dark"><strong>Noto enseguida si algo no funciona, está mal, o está fuera de lugar.</strong></h3></center><br>
