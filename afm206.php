...
<div class="card">
  <div class="card-body">
    ...
    <center><span>206 de 270</span></center><br>
<form action="afm207.php" method="POST">
    <center><h3 class="text-dark"><strong>La vida es sacrificada, muchas veces hay que aceptar lo que te toca.</strong></h3></center><br>
