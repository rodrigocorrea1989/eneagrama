...
<div class="card">
  <div class="card-body">
    ...
    <center><span>109 de 270</span></center><br>
<form action="afm110.php" method="POST">
    <center><h3 class="text-dark"><strong>Necesito que se den cuenta de mis necesidades, así como yo estoy pendiente de los demás.</strong></h3></center><br>
