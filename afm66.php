...
<div class="card">
  <div class="card-body">
    ...
    <center><span>66 de 270</span></center><br>
<form action="afm67.php" method="POST">
    <center><h3 class="text-dark"><strong>Me es muy difícil ir en contra de lo dispuesto por la autoridad.</strong></h3></center><br>
