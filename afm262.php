...
<div class="card">
  <div class="card-body">
    ...
    <center><span>262 de 270</span></center><br>
<form action="afm263.php" method="POST">
    <center><h3 class="text-dark"><strong>No soporto a quien cambia de parecer en función de las conveniencias.</strong></h3></center><br>
