...
<div class="card">
  <div class="card-body">
    ...
    <center><span>259 de 270</span></center><br>
<form action="afm260.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelen acusarme de ser una persona indecisa, cobarde, desconfiada.</strong></h3></center><br>
