...
<div class="card">
  <div class="card-body">
    ...
    <center><span>134 de 270</span></center><br>
<form action="afm135.php" method="POST">
    <center><h3 class="text-dark"><strong>Muchas veces no tengo palabras suficientes para poder expresar lo que siento.</strong></h3></center><br>
