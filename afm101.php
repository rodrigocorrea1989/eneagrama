...
<div class="card">
  <div class="card-body">
    ...
    <center><span>101 de 270</span></center><br>
<form action="afm102.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gustaría que los demás estuviesen mejor dispuestos respecto a todo.</strong></h3></center><br>
