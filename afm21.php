...
<div class="card">
  <div class="card-body">
    ...
    <center><span>21 de 270</span></center><br>
<form action="afm22.php" method="POST">
    <center><h3 class="text-dark"><strong>No puedo negar mi atención a alguien sin tener una buena excusa.</strong></h3></center><br>
