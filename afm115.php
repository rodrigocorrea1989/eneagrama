...
<div class="card">
  <div class="card-body">
    ...
    <center><span>115 de 270</span></center><br>
<form action="afm116.php" method="POST">
    <center><h3 class="text-dark"><strong>Sin leyes estrictas, es difícil decir lo que tienen que hacer las personas.</strong></h3></center><br>
