...
<div class="card">
  <div class="card-body">
    ...
    <center><span>36 de 270</span></center><br>
<form action="afm37.php" method="POST">
    <center><h3 class="text-dark"><strong>El dinero es para darse gustos y disfrutar.</strong></h3></center><br>
