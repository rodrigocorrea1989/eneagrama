...
<div class="card">
  <div class="card-body">
    ...
    <center><span>160 de 270</span></center><br>
<form action="afm161.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelo fijarme en el lado bueno de las cosas y dejar de lado el aspecto negativo de la vida.</strong></h3></center><br>
