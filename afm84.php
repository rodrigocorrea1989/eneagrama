...
<div class="card">
  <div class="card-body">
    ...
    <center><span>84 de 270</span></center><br>
<form action="afm85.php" method="POST">
    <center><h3 class="text-dark"><strong>Necesito estar siempre en actividad, me hace sentir realmente con vida</strong></h3></center><br>
