...
<div class="card">
  <div class="card-body">
    ...
    <center><span>163 de 270</span></center><br>
<form action="afm164.php" method="POST">
    <center><h3 class="text-dark"><strong>Si los demás se comprometieran como yo, no ocurrirían tantas cosas desagradables.</strong></h3></center><br>
