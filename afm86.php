...
<div class="card">
  <div class="card-body">
    ...
    <center><span>86 de 270</span></center><br>
<form action="afm87.php" method="POST">
    <center><h3 class="text-dark"><strong>Mi vida es como una montaña rusa: a veces estoy en la cima y otras en un pozo, me cuesta equilibrar mis emociones.</strong></h3></center><br>
