...
<div class="card">
  <div class="card-body">
    ...
    <center><span>69 de 270</span></center><br>
<form action="afm70.php" method="POST">
    <center><h3 class="text-dark"><strong>En cualquier juego, aunque sea sólo por diversión, siempre me gusta ganar..</strong></h3></center><br>
