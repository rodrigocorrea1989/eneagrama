...
<div class="card">
  <div class="card-body">
    ...
    <center><span>200 de 270</span></center><br>
<form action="afm201.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta proyectar, lograr éxito, triunfar.</strong></h3></center><br>
