...
<div class="card">
  <div class="card-body">
    ...
    <center><span>238 de 270</span></center><br>
<form action="afm239.php" method="POST">
    <center><h3 class="text-dark"><strong>Se puede decir que soy una persona perceptiva, analítica, estudiosa y perseverante.</strong></h3></center><br>
