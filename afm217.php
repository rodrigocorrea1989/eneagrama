...
<div class="card">
  <div class="card-body">
    ...
    <center><span>217 de 270</span></center><br>
<form action="afm218.php" method="POST">
    <center><h3 class="text-dark"><strong>Si los demás lograran estar motivados como yo, podrían vivir mejor.</strong></h3></center><br>
