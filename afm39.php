...
<div class="card">
  <div class="card-body">
    ...
    <center><span>39 de 270</span></center><br>
<form action="afm40.php" method="POST">
    <center><h3 class="text-dark"><strong>Me enojo cuando los demás no escuchan lo que tengo para decirles.</strong></h3></center><br>
