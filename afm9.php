...
<div class="card">
  <div class="card-body">
    ...
    <center><span>9 de 270</span></center><br>
<form action="afm10.php" method="POST">
    <center><h3 class="text-dark"><strong>A menudo un defecto final arruina el conjunto.</strong></h3></center><br>
