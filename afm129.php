...
<div class="card">
  <div class="card-body">
    ...
    <center><span>129 de 270</span></center><br>
<form action="afm130.php"  method="POST">
    <center><h3 class="text-dark"><strong>Puedo percibir fácilmente lo que la gente necesita.</strong></h3></center><br>
