...
<div class="card">
  <div class="card-body">
    ...
    <center><span>49 de 270</span></center><br>
<form action="afm50.php" method="POST">
    <center><h3 class="text-dark"><strong>Si los demás fueran más decididos y determinados, no malgastarían su tiempo y energía.</strong></h3></center><br>
