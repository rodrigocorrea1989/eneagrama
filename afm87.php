...
<div class="card">
  <div class="card-body">
    ...
    <center><span>87 de 270</span></center><br>
<form action="afm88.php" method="POST">
    <center><h3 class="text-dark"><strong>La vida es una oportunidad para brindarme a los otros, aspiro a dar mejor.</strong></h3></center><br>
