...
<div class="card">
  <div class="card-body">
    ...
    <center><span>112 de 270</span></center><br>
<form action="afm113.php" method="POST">
    <center><h3 class="text-dark"><strong>Si surge un problema, primero lo estudio por mi cuenta y luego lo discuto con los demás.</strong></h3></center><br>
