...
<div class="card">
  <div class="card-body">
    ...
    <center><span>207 de 270</span></center><br>
<form action="afm208.php" method="POST">
    <center><h3 class="text-dark"><strong>Aunque deba tomar una decisión sencilla, necesito contar con toda la información.</strong></h3></center><br>
