...
<div class="card">
  <div class="card-body">
    ...
    <center><span>174 de 270</span></center><br>
<form action="afm175.php" method="POST">
    <center><h3 class="text-dark"><strong>No me gusta pensar que yo pueda ser vulgar.</strong></h3></center><br>
