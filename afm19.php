...
<div class="card">
  <div class="card-body">
    ...
    <center><span>19 de 270</span></center><br>
<form action="afm20.php" method="POST">
    <center><h3 class="text-dark"><strong>Puedo luchar con convicción por lo que entiendo que es justo.</strong></h3></center><br>
