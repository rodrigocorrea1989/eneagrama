...
<div class="card">
  <div class="card-body">
    ...
    <center><span>130 de 270</span></center><br>
<form action="afm131.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelen acusarme de ser una persona agresiva, egoísta, dominante, autoritaria.</strong></h3></center><br>
