...
<div class="card">
  <div class="card-body">
    ...
    <center><span>234 de 270</span></center><br>
<form action="afm235.php" method="POST">
    <center><h3 class="text-dark"><strong>El dinero es importante porque brinda oportunidades, hay que saber invertirlo, multiplicarlo.</strong></h3></center><br>
