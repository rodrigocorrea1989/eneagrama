...
<div class="card">
  <div class="card-body">
    ...
    <center><span>222 de 270</span></center><br>
<form action="afm223.php" method="POST">
    <center><h3 class="text-dark"><strong>Descalifico a las personas que considero ignorantes.</strong></h3></center><br>
