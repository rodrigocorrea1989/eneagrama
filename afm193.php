...
<div class="card">
  <div class="card-body">
    ...
    <center><span>193 de 270</span></center><br>
<form action="afm194.php" method="POST">
    <center><h3 class="text-dark"><strong>Si los demás vieran el lado positivo de las cosas, serían más felices.</strong></h3></center><br>
