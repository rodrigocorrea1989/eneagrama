...
<div class="card">
  <div class="card-body">
    ...
    <center><span>65 de 270</span></center><br>
<form action="afm66.php" method="POST">
    <center><h3 class="text-dark"><strong>Me acusan de ser una persona dramática, pero en realidad no me comprenden.</strong></h3></center><br>
