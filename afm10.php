...
<div class="card">
  <div class="card-body">
    ...
    <center><span>10 de 270</span></center><br>
<form action="afm11.php" method="POST">
    <center><h3 class="text-dark"><strong> Puedo arbitrar desapasionadamente, porque para mí las dos partes son iguales.</strong></h3></center><br>
