...
<div class="card">
  <div class="card-body">
    ...
    <center><span>172 de 270</span></center><br>
<form action="afm173.php" method="POST">
    <center><h3 class="text-dark"><strong>Puedo encontrar lo positivo de cada situación.</strong></h3></center><br>
