...
<div class="card">
  <div class="card-body">
    ...
    <center><span>146 de 270</span></center><br>
<form action="afm147.php" method="POST">
    <center><h3 class="text-dark"><strong>Necesito mi tiempo para estar conmigo.</strong></h3></center><br>
