...
<div class="card">
  <div class="card-body">
    ...
    <center><span>196 de 270</span></center><br>
<form action="afm197.php" method="POST">
    <center><h3 class="text-dark"><strong>Son muy importantes, para mí, las formas, la estética y el buen gusto.</strong></h3></center><br>
