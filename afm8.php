...
<div class="card">
  <div class="card-body">
    ...
    <center><span>8 de 270</span></center><br>
<form action="afm9.php" method="POST">
    <center><h3 class="text-dark"><strong>Me considero una persona sensible, auténtica, especial y profunda.</strong></h3></center><br>
