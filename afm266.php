...
<div class="card">
  <div class="card-body">
    ...
    <center><span>266 de 270</span></center><br>
<form action="afm267.php" method="POST">
    <center><h3 class="text-dark"><strong>Necesito estar motivado por algo trascendente para entrar en acción.</strong></h3></center><br>
