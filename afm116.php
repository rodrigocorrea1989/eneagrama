...
<div class="card">
  <div class="card-body">
    ...
    <center><span>116 de 270</span></center><br>
<form action="afm117.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta ordenar, organizar, planificar.</strong></h3></center><br>
