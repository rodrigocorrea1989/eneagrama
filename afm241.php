...
<div class="card">
  <div class="card-body">
    ...
    <center><span>241 de 270</span></center><br>
<form action="afm242.php" method="POST">
    <center><h3 class="text-dark"><strong>Siempre pasan cosas buenas y malas, es mejor enfocarse en las buenas.</strong></h3></center><br>
