...
<div class="card">
  <div class="card-body">
    ...
    <center><span>27 de 270</span></center><br>
<form action="afm28.php" method="POST">
    <center><h3 class="text-dark"><strong>El dinero es seguridad, es necesario ahorrar.</strong></h3></center><br>
