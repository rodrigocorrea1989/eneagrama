...
<div class="card">
  <div class="card-body">
    ...
    <center><span>25 de 270</span></center><br>
<form action="afm26.php" method="POST">
    <center><h3 class="text-dark"><strong>Tengo más propensión a resignarme que a luchar.</strong></h3></center><br>
