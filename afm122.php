...
<div class="card">
  <div class="card-body">
    ...
    <center><span>122 de 270</span></center><br>
<form action="afm123.php"  method="POST">
    <center><h3 class="text-dark"><strong>Si los demás pensaran más en el prójimo, el mundo sería más solidario.</strong></h3></center><br>
