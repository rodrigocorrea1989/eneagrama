...
<div class="card">
  <div class="card-body">
    ...
    <center><span>180 de 270</span></center><br>
<form action="afm181.php" method="POST">
    <center><h3 class="text-dark"><strong>Aunque generalmente no lo exprese, me irrito fácilmente cuando los demás no hacen lo que corresponde.</strong></h3></center><br>
