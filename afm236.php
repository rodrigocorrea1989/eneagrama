...
<div class="card">
  <div class="card-body">
    ...
    <center><span>236 de 270</span></center><br>
<form action="afm237.php" method="POST">
    <center><h3 class="text-dark"><strong>Me fastidia que me perturben.</strong></h3></center><br>
