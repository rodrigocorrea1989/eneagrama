...
<div class="card">
  <div class="card-body">
    ...
    <center><span>6 de 270</span></center><br>
<form action="afm7.php" method="POST">
    <center><h3 class="text-dark"><strong> El dinero es secundario, sólo sirve para atender las necesidades.</strong></h3></center><br>
