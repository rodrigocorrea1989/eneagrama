...
<div class="card">
  <div class="card-body">
    ...
    <center><span>182 de 270</span></center><br>
<form action="afm183.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta que me den tiempo para terminar las cosas que tengo que hacer y para tomar mis decisiones.</strong></h3></center><br>
