...
<div class="card">
  <div class="card-body">
    ...
    <center><span>59 de 270</span></center><br>
<form action="afm60.php" method="POST">
    <center><h3 class="text-dark"><strong>La vida es una sucesión de emociones profundas, aspiro a vivir mejor.</strong></h3></center><br>
