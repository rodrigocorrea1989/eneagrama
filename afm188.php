...
<div class="card">
  <div class="card-body">
    ...
    <center><span>188 de 270</span></center><br>
<form action="afm189.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta disfrutar y que todos disfrutemos.</strong></h3></center><br>
