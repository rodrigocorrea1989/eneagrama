...
<div class="card">
  <div class="card-body">
    ...
    <center><span>53 de 270</span></center><br>
<form action="afm54.php" method="POST">
    <center><h3 class="text-dark"><strong>Me esfuerzo mucho por corregir mis faltas.</strong></h3></center><br>
