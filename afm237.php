...
<div class="card">
  <div class="card-body">
    ...
    <center><span>237 de 270</span></center><br>
<form action="afm238.php" method="POST">
    <center><h3 class="text-dark"><strong>Me molesta el dinero, mejor gastarlo en algo refinado, exquisito.</strong></h3></center><br>
