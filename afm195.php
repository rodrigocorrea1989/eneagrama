...
<div class="card">
  <div class="card-body">
    ...
    <center><span>195 de 270</span></center><br>
<form action="afm196.php" method="POST">
    <center><h3 class="text-dark"><strong>El dinero me da tranquilidad.</strong></h3></center><br>
