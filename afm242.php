...
<div class="card">
  <div class="card-body">
    ...
    <center><span>242 de 270</span></center><br>
<form action="afm243.php" method="POST">
    <center><h3 class="text-dark"><strong>Hay muchas personas que dependen de mi ayuda y generosidad.</strong></h3></center><br>
