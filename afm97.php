...
<div class="card">
  <div class="card-body">
    ...
    <center><span>97 de 270</span></center><br>
<form action="afm98.php" method="POST">
    <center><h3 class="text-dark"><strong>Si algo no está bien, realmente me molesta.</strong></h3></center><br>
