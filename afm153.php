...
<div class="card">
  <div class="card-body">
    ...
    <center><span>153 de 270</span></center><br>
<form action="afm154.php" method="POST">
    <center><h3 class="text-dark"><strong>Jamás podría dar un paso al costado pensando que alguien pueda dirijir un grupo mejor que yo.</strong></h3></center><br>
