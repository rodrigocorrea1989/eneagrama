...
<div class="card">
  <div class="card-body">
    ...
    <center><span>29 de 270</span></center><br>
<form action="afm30.php" method="POST">
    <center><h3 class="text-dark"><strong>La vida es una oportunidad para alcanzar aquello que me propongo, aspiro a hacer mejor.</strong></h3></center><br>
