...
<div class="card">
  <div class="card-body">
    ...
    <center><span>265 de 270</span></center><br>
<form action="afm266.php" method="POST">
    <center><h3 class="text-dark"><strong>Se puede decir que soy una persona entusiasta, curiosa, divertida, simpática, alegre y optimista.</strong></h3></center><br>
