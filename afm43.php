...
<div class="card">
  <div class="card-body">
    ...
    <center><span>43 de 270</span></center><br>
<form action="afm44.php" method="POST">
    <center><h3 class="text-dark"><strong>Tiendo a quitar importancia a las cosas para que los demás se tranquilicen.</strong></h3></center><br>
