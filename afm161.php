...
<div class="card">
  <div class="card-body">
    ...
    <center><span>161 de 270</span></center><br>
<form action="afm162.php" method="POST">
    <center><h3 class="text-dark"><strong>Me encanta disponer de tiempo libre para descansar.</strong></h3></center><br>
