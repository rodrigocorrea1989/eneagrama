...
<div class="card">
  <div class="card-body">
    ...
    <center><span>186 de 270</span></center><br>
<form action="afm187.php" method="POST">
    <center><h3 class="text-dark"><strong>La vida es una ocasión para reflexionar y aprender, aspiro a entender mejor.</strong></h3></center><br>
