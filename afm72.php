...
<div class="card">
  <div class="card-body">
    ...
    <center><span>72 de 270</span></center><br>
<form action="afm73.php" method="POST">
    <center><h3 class="text-dark"><strong>A veces soy una persona muy impulsiva, impongo mis verdades..</strong></h3></center><br>
