...
<div class="card">
  <div class="card-body">
    ...
    <center><span>24 de 270</span></center><br>
<form action="afm25.php" method="POST">
    <center><h3 class="text-dark"><strong>Con frecuencia mis propias críticas y las de otros pululan en mi cabeza.</strong></h3></center><br>
