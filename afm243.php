...
<div class="card">
  <div class="card-body">
    ...
    <center><span>243 de 270</span></center><br>
<form action="afm244.php" method="POST">
    <center><h3 class="text-dark"><strong>A veces necesito dejar de lado alguna norma si ésta me impide llegar a mis objetivos.</strong></h3></center><br>
