...
<div class="card">
  <div class="card-body">
    ...
    <center><span>71 de 270</span></center><br>
<form action="afm72.php" method="POST">
    <center><h3 class="text-dark"><strong>Las cosas siempre funcionan de la mejor manera posible.</strong></h3></center><br>
