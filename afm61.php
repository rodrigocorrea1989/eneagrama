...
<div class="card">
  <div class="card-body">
    ...
    <center><span>61 de 270</span></center><br>
<form action="afm62.php" method="POST">
    <center><h3 class="text-dark"><strong>Necesito vivir intensamente, sentir la adrenalina.</strong></h3></center><br>
