...
<div class="card">
  <div class="card-body">
    ...
    <center><span>40 de 270</span></center><br>
<form action="afm41.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelen acusarme de ser una persona posesiva, manipuladora.</strong></h3></center><br>
