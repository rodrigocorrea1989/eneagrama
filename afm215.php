...
<div class="card">
  <div class="card-body">
    ...
    <center><span>215 de 270</span></center><br>
<form action="afm216.php" method="POST">
    <center><h3 class="text-dark"><strong>Disfruto en el ejercicio del poder.</strong></h3></center><br>
