...
<div class="card">
  <div class="card-body">
    ...
    <center><span>133 de 270</span></center><br>
<form action="afm134.php" method="POST">
    <center><h3 class="text-dark"><strong>Trato de resolver mis problemas pensando.</strong></h3></center><br>
