...
<div class="card">
  <div class="card-body">
    ...
    <center><span>165 de 270</span></center><br>
<form action="afm166.php" method="POST">
    <center><h3 class="text-dark"><strong>Se puede decir que soy una persona paciente, diplomática, conciliadora.</strong></h3></center><br>
