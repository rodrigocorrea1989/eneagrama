...
<div class="card">
  <div class="card-body">
    ...
    <center><span>18 de 270</span></center><br>
<form action="afm19.php" method="POST">
    <center><h3 class="text-dark"><strong>A menudo me siento atrás para observar a los demás, en lugar de involucrarme en la acción.</strong></h3></center><br>
