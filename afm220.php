...
<div class="card">
  <div class="card-body">
    ...
    <center><span>220 de 270</span></center><br>
<form action="afm221.php" method="POST">
    <center><h3 class="text-dark"><strong>Soy una persona que casi siempre está calmada y tranquila.</strong></h3></center><br>
