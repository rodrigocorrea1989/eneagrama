...
<div class="card">
  <div class="card-body">
    ...
    <center><span>233 de 270</span></center><br>
<form action="afm234.php" method="POST">
    <center><h3 class="text-dark"><strong>La vida es una oportunidad de pasarla bien y si hay penas, olvidarlas.</strong></h3></center><br>
