...
<div class="card">
  <div class="card-body">
    ...
    <center><span>117 de 270</span></center><br>
<form action="afm118.php" method="POST">
    <center><h3 class="text-dark"><strong>La vida es simple, para qué complicarnos.</strong></h3></center><br>
