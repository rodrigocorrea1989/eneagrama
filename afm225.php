...
<div class="card">
  <div class="card-body">
    ...
    <center><span>225 de 270</span></center><br>
<form action="afm226.php" method="POST">
    <center><h3 class="text-dark"><strong>Aunque haya tomado una decisión, con frecuencia me replanteo si habrá sido la correcta.</strong></h3></center><br>
