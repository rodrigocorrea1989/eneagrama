...
<div class="card">
  <div class="card-body">
    ...
    <center><span>249 de 270</span></center><br>
<form action="afm250.php" method="POST">
    <center><h3 class="text-dark"><strong>El tiempo es necesario para hacer lo que se debe.</strong></h3></center><br>
