...
<div class="card">
  <div class="card-body">
    ...
    <center><span>2 de 270</span></center><br>
<form action="afm3.php" method="POST">
    <center><h3 class="text-dark"><strong>Me cuesta convencerme de que aquello que compré fue una buena decisión.</strong></h3></center><br>
