...
<div class="card">
  <div class="card-body">
    ...
    <center><span>177 de 270</span></center><br>
<form action="afm178.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta saber el porqué de las cosas, profundizar mis conocimientos, aunque después no los comparta a los demás.</strong></h3></center><br>
