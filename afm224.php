...
<div class="card">
  <div class="card-body">
    ...
    <center><span>224 de 270</span></center><br>
<form action="afm225.php" method="POST">
    <center><h3 class="text-dark"><strong>Me comunico con mis amistades más a menudo de lo que ellas se comunican conmigo.</strong></h3></center><br>
