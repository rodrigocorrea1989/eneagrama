...
<div class="card">
  <div class="card-body">
    ...
    <center><span>197 de 270</span></center><br>
<form action="afm198.php" method="POST">
    <center><h3 class="text-dark"><strong>Juzgo el comportamiento de la gente sin pensar en sus motivaciones.</strong></h3></center><br>
