...
<div class="card">
  ...
  <span class="bg-dark text-light p-2">Eneagrama de <?php echo $nombre ?></span><br><br>
    <center><span>3 de 270</span></center><br>
<form action="afm4.php" method="POST">
    <center><h3 class="text-dark"><strong> No hay nada tan urgente que no pueda esperar hasta mañana.</strong></h3></center><br>
