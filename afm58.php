...
<div class="card">
  <div class="card-body">
    ...
    <center><span>58 de 270</span></center><br>
<form action="afm59.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta ver las cosas en perspectiva, retroceder e incluirlo todo. Si dejo algo fuera, me acuso por ser tan simplista.</strong></h3></center><br>
