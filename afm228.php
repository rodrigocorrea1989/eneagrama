...
<div class="card">
  <div class="card-body">
    ...
    <center><span>228 de 270</span></center><br>
<form action="afm229.php" method="POST">
    <center><h3 class="text-dark"><strong>No me gusta perder tiempo con los demás cuando puedo estar leyendo un buen libro o navegando por Internet.</strong></h3></center><br>
