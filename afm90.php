...
<div class="card">
  <div class="card-body">
    ...
    <center><span>90 de 270</span></center><br>
<form action="afm91.php" method="POST">
    <center><h3 class="text-dark"><strong>La vida es una lucha constante, hay que enfrentarla con coraje.</strong></h3></center><br>
