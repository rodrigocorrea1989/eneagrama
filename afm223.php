...
<div class="card">
  <div class="card-body">
    ...
    <center><span>223 de 270</span></center><br>
<form action="afm224.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelen acusarme de ser una persona inflexible, formal, celosa, controladora, obsesiva.</strong></h3></center><br>
