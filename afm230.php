...
<div class="card">
  <div class="card-body">
    ...
    <center><span>230 de 270</span></center><br>
<form action="afm231.php" method="POST">
    <center><h3 class="text-dark"><strong>Me doy cuenta de los puntos débiles de los demás y los ataco si me provocan.</strong></h3></center><br>
