...
<div class="card">
  <div class="card-body">
    ...
    <center><span>250 de 270</span></center><br>
<form action="afm251.php" method="POST">
    <center><h3 class="text-dark"><strong>Una de mis cualidades es la habilidad para describir mis estados internos.</strong></h3></center><br>
