...
<div class="card">
  <div class="card-body">
    ...
    <center><span>76 de 270</span></center><br>
<form action="afm77.php" method="POST">
    <center><h3 class="text-dark"><strong>Si los demás fueran más apacibles y relajados viviríamos en un mundo más tranquilo.</strong></h3></center><br>
