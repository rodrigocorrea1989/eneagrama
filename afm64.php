...
<div class="card">
  <div class="card-body">
    ...
    <center><span>64 de 270</span></center><br>
<form action="afm65.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta intimar, servir, entregar.</strong></h3></center><br>
