...
<div class="card">
  <div class="card-body">
    ...
    <center><span>270 de 270</span></center><br>
<form action="con2.php" method="POST">
    <center><h3 class="text-dark"><strong>A menudo hay personas que se me acercan pidiéndome que las conforte y las aconseje.</strong></h3></center><br>
