...
<div class="card">
  <div class="card-body">
    ...
    <center><span>54 de 270</span></center><br>
<form action="afm55.php" method="POST">
    <center><h3 class="text-dark"><strong>Ante la inseguridad reacciono volviéndome una persona terca y poniéndome a la defensiva.</strong></h3></center><br>
