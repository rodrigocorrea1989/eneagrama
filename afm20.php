...
<div class="card">
  <div class="card-body">
    ...
    <center><span>20 de 270</span></center><br>
<form action="afm21.php" method="POST">
    <center><h3 class="text-dark"><strong>Cuando me enojo, pienso que las personas son ignorantes, poco profundas, etc.</strong></h3></center><br>
