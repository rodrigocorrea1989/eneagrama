...
<div class="card">
  <div class="card-body">
    ...
    <center><span>175 de 270</span></center><br>
<form action="afm176.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelen acusarme de ser una persona apática, pasiva, abstraída de la realidad.</strong></h3></center><br>
