...
<div class="card">
  <div class="card-body">
    ...
    <center><span>120 de 270</span></center><br>
<form action="afm121.php" method="POST">
    <center><h3 class="text-dark"><strong>Si los demás se parecieran a mí, todo sería mejor</strong></h3></center><br>
