...
<div class="card">
  <div class="card-body">
    ...
    <center><span>62 de 270</span></center><br>
<form action="afm63.php" method="POST">
    <center><h3 class="text-dark"><strong>Hacer lo correcto me lleva a sacrificar el tiempo que tendría para el ocio y al descanso.</strong></h3></center><br>
