...
<div class="card">
  <div class="card-body">
    ...
    <center><span>184 de 270</span></center><br>
<form action="afm185.php" method="POST">
    <center><h3 class="text-dark"><strong>Puedo detectar nuevas oportunidades en las distintas situaciones que vivo.</strong></h3></center><br>
