...
<div class="card">
  <div class="card-body">
    ...
    <center><span>166 de 270</span></center><br>
<form action="afm167.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelo pasar de una cosa a otra, en vez de profundizar en una sola.</strong></h3></center><br>
