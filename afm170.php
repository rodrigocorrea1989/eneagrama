...
<div class="card">
  <div class="card-body">
    ...
    <center><span>170 de 270</span></center><br>
<form action="afm171.php" method="POST">
    <center><h3 class="text-dark"><strong>Mi entrega a los demás muchas veces ha repercutido en mi propia salud o bienestar.</strong></h3></center><br>
