...
<div class="card">
  <div class="card-body">
    ...
    <center><span>70 de 270</span></center><br>
<form action="afm71.php" method="POST">
    <center><h3 class="text-dark"><strong>Normalmente soy una persona demasiado intransigente y exigente con los demás.</strong></h3></center><br>
