...
<div class="card">
  <div class="card-body">
    ...
    <center><span>89 de 270</span></center><br>
<form action="afm90.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta casi todo lo que encuentro.</strong></h3></center><br>
