...
<div class="card">
  <div class="card-body">
    ...
    <center><span>96 de 270</span></center><br>
<form action="afm97.php" method="POST">
    <center><h3 class="text-dark"><strong>Me cuesta compartir mis sentimientos más profundos porque temo que desvaloricen mi imagen.</strong></h3></center><br>
