...
<div class="card">
  <div class="card-body">
    ...
    <center><span>45 de 270</span></center><br>
<form action="afm46.php" method="POST">
    <center><h3 class="text-dark"><strong>Actúo con sentido del deber y responsabilidad.</strong></h3></center><br>
