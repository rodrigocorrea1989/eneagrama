...
<div class="card">
  <div class="card-body">
    ...
    <center><span>33 de 270</span></center><br>
<form action="afm34.php" method="POST">
    <center><h3 class="text-dark"><strong>Frecuentemente me encuentro evaluando a los demás como posibles amenazas para mí.</strong></h3></center><br>
