...
<div class="card">
  ...
  <span class="bg-dark text-light p-2">Eneagrama de <?php echo $nombre ?></span><br><br>
    <center><span>4 de 270</span></center><br>
<form action="afm5.php" method="POST">
    <center><h3 class="text-dark"><strong> Siento que soy una persona apreciada por los demás a través de mis logros.</strong></h3></center><br>
