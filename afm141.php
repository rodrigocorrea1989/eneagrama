...
<div class="card">
  <div class="card-body">
    ...
    <center><span>141 de 270</span></center><br>
<form action="afm142.php" method="POST">
    <center><h3 class="text-dark"><strong>El tiempo es oro, debe utilizarse de manera productiva.</strong></h3></center><br>
