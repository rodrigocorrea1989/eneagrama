...
<div class="card">
  <div class="card-body">
    ...
    <center><span>147 de 270</span></center><br>
<form action="afm148.php" method="POST">
    <center><h3 class="text-dark"><strong>Prefiero hablar suavemente, sin exaltarme ni levantar la voz.</strong></h3></center><br>
