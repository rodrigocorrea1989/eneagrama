...
<div class="card">
  <div class="card-body">
    ...
    <center><span>118 de 270</span></center><br>
<form action="afm119.php" method="POST">
    <center><h3 class="text-dark"><strong>Soy sumamente competente, mi vida es interesante.</strong></h3></center><br>
