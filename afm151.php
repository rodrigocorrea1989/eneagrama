...
<div class="card">
  <div class="card-body">
    ...
    <center><span>151 de 270</span></center><br>
<form action="afm152.php" method="POST">
    <center><h3 class="text-dark"><strong>Soy visto por los demás como una persona que logra lo que se propone.</strong></h3></center><br>
