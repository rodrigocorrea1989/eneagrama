...
<div class="card">
  <div class="card-body">
    ...
    <center><span>105 de 270</span></center><br>
<form action="afm106.php" method="POST">
    <center><h3 class="text-dark"><strong>A veces soy una persona demasiado generosa.</strong></h3></center><br>
