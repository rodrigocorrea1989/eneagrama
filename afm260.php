...
<div class="card">
  <div class="card-body">
    ...
    <center><span>260 de 270</span></center><br>
<form action="afm261.php" method="POST">
    <center><h3 class="text-dark"><strong>El tiempo es la oportunidad de poder hacer de todo.</strong></h3></center><br>
