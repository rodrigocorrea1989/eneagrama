...
<div class="card">
  <div class="card-body">
    ...
    <center><span>159 de 270</span></center><br>
<form action="afm160.php" method="POST">
    <center><h3 class="text-dark"><strong>La vida es una oportunidad para mejorar cada día, aspiro a ser mejor.</strong></h3></center><br>
