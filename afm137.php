...
<div class="card">
  <div class="card-body">
    ...
    <center><span>137 de 270</span></center><br>
<form action="afm138.php" method="POST">
    <center><h3 class="text-dark"><strong>Me identifico con mi grupo y desconfío de los demás.</strong></h3></center><br>
