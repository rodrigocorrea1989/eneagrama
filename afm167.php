...
<div class="card">
  <div class="card-body">
    ...
    <center><span>167 de 270</span></center><br>
<form action="afm168.php" method="POST">
    <center><h3 class="text-dark"><strong>Se puede decir que soy una persona cálida, introspectiva, intuitiva.</strong></h3></center><br>
