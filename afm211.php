...
<div class="card">
  <div class="card-body">
    ...
    <center><span>211 de 270</span></center><br>
<form action="afm212.php" method="POST">
    <center><h3 class="text-dark"><strong>Se puede decir que soy una persona ética, confiable, productiva, ordenada y honesta.</strong></h3></center><br>
