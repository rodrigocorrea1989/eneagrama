...
<div class="card">
  <div class="card-body">
    ...
    <center><span>104 de 270</span></center><br>
<form action="afm105.php" method="POST">
    <center><h3 class="text-dark"><strong>Muchas veces siento que no hay nadie como yo, otras que los demás son mejores.</strong></h3></center><br>
