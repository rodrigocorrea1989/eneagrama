...
<div class="card">
  <div class="card-body">
    ...
    <center><span>81 de 270</span></center><br>
<form action="afm82.php" method="POST">
    <center><h3 class="text-dark"><strong>Aunque a veces no quisiera comprometerme, me cuesta decir que no y poner límites a mi entrega.</strong></h3></center><br>
