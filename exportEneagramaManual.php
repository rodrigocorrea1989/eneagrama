...
$nombre=$_POST["nombre"];
$fechaIngles=htmlentities(addslashes($_POST["fecha"]));
$fecha=date("d-m-Y",strtotime($fechaIngles));
...
$pdf->Text(98,66.5,$mayor_media);
$pdf->Text(98,70.5,$igual_media);
$pdf->Text(98,74.8,$menor_media);
...
$max_poladridad=max($orden_aire,$relacion_agua,$imagen_tierra,$fuerza_fuego);
$min_polaridad=min($orden_aire,$relacion_agua,$imagen_tierra,$fuerza_fuego);
...
$porcentajeEnfrentarRedondeado=round($porcentaje_enfrentar)."%";
$pdf->Text(44,246.9,$porcentajeEnfrentarRedondeado);
$pdf->Text(40.5,251,$posicion_enfrentar);
...
$porcentajeAcercarRedondeado=round($porcentaje_acercar)."%";
$pdf->Text(44,262,$porcentajeAcercarRedondeado);
$pdf->Text(40.5,265.8,$posicion_acercar);
...
$porcentajeAlejarRedondeado=round($porcentaje_alejar)."%";
$pdf->Text(44,276.5,$porcentajeAlejarRedondeado);
$pdf->Text(40.5,280.5,$posicion_alejar);
...
$porcentajeCombativoRedondeado=round($porcentaje_combativo)."%";
$pdf->Text(88,247.2,$porcentajeCombativoRedondeado);
$pdf->SetFont('Arial','B',6.8);
$pdf->Text(85.5,251,$posicion_combativo);
...
$porcentajeSumisosRedondeado=round($porcentaje_sumisos)."%";
$pdf->Text(88,262,$porcentajeSumisosRedondeado);
$pdf->SetFont('Arial','B',6.8);
$pdf->Text(85.5,265.8,$posicion_sumisos);
...
$porcentajeRetiradosRedondeado=round($porcentaje_retirados)."%";
$pdf->Text(88,276.7,$porcentajeRetiradosRedondeado);
$pdf->SetFont('Arial','B',6.8);
$pdf->Text(85.5,280.2,$posicion_retirados);
...
$porcentajeReactivosRedondeado=round($porcentaje_reactivos)."%";
$pdf->Text(130,247.2,$porcentajeReactivosRedondeado);
$pdf->SetFont('Arial','B',6.8);
$pdf->Text(127,251,$posicion_reactivos);
...
$porcentajeEficacesRedondeado=round($porcentaje_eficaces)."%";
$pdf->Text(130,262,$porcentajeEficacesRedondeado);
$pdf->SetFont('Arial','B',6.8);
$pdf->Text(127,265.8,$posicion_eficaces);
...
$porcentajeOptimistasRedondeado=round($porcentaje_optimistas)."%";
$pdf->Text(130,276.7,$porcentajeOptimistasRedondeado);
$pdf->SetFont('Arial','B',6.8);
$pdf->Text(127,280.2,$posicion_optimistas);
