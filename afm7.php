...
<div class="card">
  <div class="card-body">
    ...
    <center><span>7 de 270</span></center><br>
<form action="afm8.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelen acusarme de ser una persona indisciplinada, dispersa, inquieta, superficial.</strong></h3></center><br>
