...
<div class="card">
  <div class="card-body">
    ...
    <center><span>216 de 270</span></center><br>
<form action="afm217.php" method="POST">
    <center><h3 class="text-dark"><strong>A veces soy una persona dispersa y curiosa, todo me interesa.</strong></h3></center><br>
