...
<div class="card">
  <div class="card-body">
    ...
    <center><span>12 de 270</span></center><br>
<form action="afm13.php" method="POST">
    <center><h3 class="text-dark"><strong> Me gusta la buena compañía, el afecto, la independencia y las conversaciones estimulantes y graciosas.</strong></h3></center><br>
