...
<div class="card">
  <div class="card-body">
    ...
    <center><span>31 de 270</span></center><br>
<form action="afm32.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta sintetizar y reunir ideas diferentes.</strong></h3></center><br>
