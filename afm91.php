...
<div class="card">
  <div class="card-body">
    ...
    <center><span>91 de 270</span></center><br>
<form action="afm92.php" method="POST">
    <center><h3 class="text-dark"><strong>No sé como participar en conversaciones intrascendentes.</strong></h3></center><br>
