...
<div class="card">
  <div class="card-body">
    ...
    <center><span>14 de 270</span></center><br>
<form action="afm15.php" method="POST">
    <center><h3 class="text-dark"><strong> Me gusta demostrar que puedo hacer lo que me propongo, aunque me consuma todo el tiempo.</strong></h3></center><br>
