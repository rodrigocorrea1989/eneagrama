...
<div class="card">
  <div class="card-body">
    ...
    <center><span>83 de 270</span></center><br>
<form action="afm84.php" method="POST">
    <center><h3 class="text-dark"><strong>Me pregunto a menudo si tengo suficiente valor para hacer lo que hay que hacer.</strong></h3></center><br>
