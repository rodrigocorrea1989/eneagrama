...
<div class="card">
  <div class="card-body">
    ...
    <center><span>162 de 270</span></center><br>
<form action="afm163.php" method="POST">
    <center><h3 class="text-dark"><strong>El dinero me permite reafirmar mi poder.</strong></h3></center><br>
