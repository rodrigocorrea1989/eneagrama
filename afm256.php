...
<div class="card">
  <div class="card-body">
    ...
    <center><span>256 de 270</span></center><br>
<form action="afm257.php" method="POST">
    <center><h3 class="text-dark"><strong>No tengo problemas de tomar riesgos.</strong></h3></center><br>
