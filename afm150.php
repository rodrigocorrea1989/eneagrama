...
<div class="card">
  <div class="card-body">
    ...
    <center><span>150 de 270</span></center><br>
<form action="afm151.php" method="POST">
    <center><h3 class="text-dark"><strong>Me considero una persona inteligente, objetiva, racional, sabia y profunda.</strong></h3></center><br>
