...
<div class="card">
  <div class="card-body">
    ...
    <center><span>38 de 270</span></center><br>
<form action="afm39.php" method="POST">
    <center><h3 class="text-dark"><strong>Generalmente, y hasta tener todo pensado, me lleva bastante tiempo empezar o hacer algo.</strong></h3></center><br>
