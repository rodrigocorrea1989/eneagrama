...
<div class="card">
  <div class="card-body">
    ...
    <center><span>34 de 270</span></center><br>
<form action="afm35.php" method="POST">
    <center><h3 class="text-dark"><strong>Tiendo a no juzgar a las personas.</strong></h3></center><br>
