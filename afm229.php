...
<div class="card">
  <div class="card-body">
    ...
    <center><span>229 de 270</span></center><br>
<form action="afm230.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelo proyectar mis miedos a los demás.</strong></h3></center><br>
