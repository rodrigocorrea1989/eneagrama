...
<div class="card">
  <div class="card-body">
    ...
    <center><span>41 de 270</span></center><br>
<form action="afm42.php" method="POST">
    <center><h3 class="text-dark"><strong>Me considero una persona fuerte, justa, independiente y enérgica.</strong></h3></center><br>
