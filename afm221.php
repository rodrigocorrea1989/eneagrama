...
<div class="card">
  <div class="card-body">
    ...
    <center><span>221 de 270</span></center><br>
<form action="afm222.php" method="POST">
    <center><h3 class="text-dark"><strong>Me doy cuenta fácilmente donde reside el poder en un grupo.</strong></h3></center><br>
