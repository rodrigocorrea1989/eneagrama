...
<div class="card">
  <div class="card-body">
    ...
    <center><span>13 de 270</span></center><br>
<form action="afm14.php" method="POST">
    <center><h3 class="text-dark"><strong> Soy una persona libre, nada me detiene.</strong></h3></center><br>
