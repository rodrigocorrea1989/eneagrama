...
<div class="card">
  <div class="card-body">
    ...
    <center><span>158 de 270</span></center><br>
<form action="afm159.php" method="POST">
    <center><h3 class="text-dark"><strong>Mi deseo de atender mis necesidades personales ha repercutido negativamente en mis relaciones.</strong></h3></center><br>
