...
<div class="card">
  <div class="card-body">
    ...
    <center><span>239 de 270</span></center><br>
<form action="afm240.php" method="POST">
    <center><h3 class="text-dark"><strong>Me importa mucho lo que los otros puedan llegar a pensar de mí.</strong></h3></center><br>
