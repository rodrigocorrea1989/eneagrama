...
<div class="card">
  <div class="card-body">
    ...
    <center><span>68 de 270</span></center><br>
<form action="afm69.php" method="POST">
    <center><h3 class="text-dark"><strong>Me considero una persona simple, serena, equilibrada.</strong></h3></center><br>
