...
<div class="card">
  <div class="card-body">
    ...
    <center><span>80 de 270</span></center><br>
<form action="afm81.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta ser quien decide y defender a los que están conmigo, aunque tenga que enfrentar cualquier situación.</strong></h3></center><br>
