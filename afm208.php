...
<div class="card">
  <div class="card-body">
    ...
    <center><span>208 de 270</span></center><br>
<form action="afm209.php" method="POST">
    <center><h3 class="text-dark"><strong>Prefiero aislarme para pensar lo que siento.</strong></h3></center><br>
