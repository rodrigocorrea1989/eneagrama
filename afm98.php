...
<div class="card">
  <div class="card-body">
    ...
    <center><span>98 de 270</span></center><br>
<form action="afm99.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta dar para que me acepten, aunque tenga que postergar mis propias necesidades.</strong></h3></center><br>
