...
<div class="card">
  <div class="card-body">
    ...
    <center><span>154 de 270</span></center><br>
<form action="afm155.php" method="POST">
    <center><h3 class="text-dark"><strong>Se puede decir que soy una persona eficiente, enérgica, emprendedora, efectiva, exitosa.</strong></h3></center><br>
