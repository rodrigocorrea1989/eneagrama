...
<div class="card">
  <div class="card-body">
    ...
    <center><span>138 de 270</span></center><br>
<form action="afm139.php" method="POST">
    <center><h3 class="text-dark"><strong>Mi teoría es que si algo es bueno, más es mejor.</strong></h3></center><br>
