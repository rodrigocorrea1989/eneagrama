...
<div class="card">
  <div class="card-body">
    ...
    <center><span>232 de 270</span></center><br>
<form action="afm233.php" method="POST">
    <center><h3 class="text-dark"><strong>Tiendo a ser sensible y a permanecer en mi mundo.</strong></h3></center><br>
