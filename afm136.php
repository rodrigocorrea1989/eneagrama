...
<div class="card">
  <div class="card-body">
    ...
    <center><span>136 de 270</span></center><br>
<form action="afm137.php" method="POST">
    <center><h3 class="text-dark"><strong>No entiendo a la gente que vive apurada, estresada.</strong></h3></center><br>
