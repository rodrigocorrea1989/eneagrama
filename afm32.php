...
<div class="card">
  <div class="card-body">
    ...
    <center><span>32 de 270</span></center><br>
<form action="afm33.php" method="POST">
    <center><h3 class="text-dark"><strong>Me cuesta relajarme y estar alegre..</strong></h3></center><br>
