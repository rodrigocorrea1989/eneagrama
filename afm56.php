...
<div class="card">
  <div class="card-body">
    ...
    <center><span>56 de 270</span></center><br>
<form action="afm57.php" method="POST">
    <center><h3 class="text-dark"><strong>La gente suele pensar que soy el alma de las reuniones.</strong></h3></center><br>
