...
<div class="card">
  <div class="card-body">
    ...
    <center><span>51 de 270</span></center><br>
<form action="afm52.php" method="POST">
    <center><h3 class="text-dark"><strong>La mayoría de la gente no tiene sentimientos profundos como los míos..</strong></h3></center><br>
