...
<div class="card">
  <div class="card-body">
    ...
    <center><span>60 de 270</span></center><br>
<form action="afm61.php" method="POST">
    <center><h3 class="text-dark"><strong>Es muy importante para mi la lealtad al grupo.</strong></h3></center><br>
