...
<div class="card">
  <div class="card-body">
    ...
    <center><span>15 de 270</span></center><br>
<form action="afm16.php" method="POST">
    <center><h3 class="text-dark"><strong> Con frecuencia me enfado porque ni yo ni los demás hacemos mejor las cosas.</strong></h3></center><br>
