...
<div class="card">
  <div class="card-body">
    ...
    <center><span>185 de 270</span></center><br>
<form action="afm186.php" method="POST">
    <center><h3 class="text-dark"><strong>Me siento bien teniendo todo bajo control.</strong></h3></center><br>
