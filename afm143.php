...
<div class="card">
  <div class="card-body">
    ...
    <center><span>143 de 270</span></center><br>
<form action="afm144.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gustan que me sigan cuando asumo retos en situaciones críticas, o están conmigo o en mi contra.</strong></h3></center><br>
