...
<div class="card">
  <div class="card-body">
    ...
    <center><span>132 de 270</span></center><br>
<form action="afm133.php" method="POST">
    <center><h3 class="text-dark"><strong>Me resulta difícil aceptar compromisos a largo plazo.</strong></h3></center><br>
