...
<div class="card">
  <div class="card-body">
    ...
    <center><span>179 de 270</span></center><br>
<form action="afm180.php" method="POST">
    <center><h3 class="text-dark"><strong>Mi actitud de servicio me lleva a una dedicación activa, poniendo todo mi tiempo y esfuerzo.</strong></h3></center><br>
