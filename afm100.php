...
<div class="card">
  <div class="card-body">
    ...
    <center><span>100 de 270</span></center><br>
<form action="afm101.php" method="POST">
    <center><h3 class="text-dark"><strong>Por naturaleza soy una persona reservada, introvertida, independiente.</strong></h3></center><br>
