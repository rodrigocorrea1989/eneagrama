...
<div class="card">
  <div class="card-body">
    ...
    <center><span>5 de 270</span></center><br>
<form action="afm6.php" method="POST">
    <center><h3 class="text-dark"><strong> Me duele mucho cuando mis amistades se reunen y no me participan.</strong></h3></center><br>
