...
<div class="card">
  <div class="card-body">
    ...
    <center><span>156 de 270</span></center><br>
<form action="afm157.php" method="POST">
    <center><h3 class="text-dark"><strong>Muchas veces me encuentro con sobrecargas por tener que atender la dependencia de otros respecto de mí.</strong></h3></center><br>
