...
<div class="card">
  <div class="card-body">
    ...
    <center><span>48 de 270</span></center><br>
<form action="afm49.php" method="POST">
    <center><h3 class="text-dark"><strong>Puedo conciliar para que reine la armonía.</strong></h3></center><br>
