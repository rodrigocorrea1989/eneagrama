...
<div class="card">
  <div class="card-body">
    ...
    <center><span>254 de 270</span></center><br>
<form action="afm255.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta que respeten mi soledad y mi distancia para poder procesar mis emociones y pensamientos.</strong></h3></center><br>
