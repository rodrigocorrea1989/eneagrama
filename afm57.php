...
<div class="card">
  <div class="card-body">
    ...
    <center><span>57 de 270</span></center><br>
<form action="afm58.php" method="POST">
    <center><h3 class="text-dark"><strong>Las primeras impresiones son muy importantes, por eso me gusta proyectar una imagen triunfadora.</strong></h3></center><br>
