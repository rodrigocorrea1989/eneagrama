...
<div class="card">
  <div class="card-body">
    ...
    <center><span>30 de 270</span></center><br>
<form action="afm31.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta liderar, defender, luchar y protejer.</strong></h3></center><br>
