...
<div class="card">
  <div class="card-body">
    ...
    <center><span>77 de 270</span></center><br>
<form action="afm78.php" method="POST">
    <center><h3 class="text-dark"><strong>Me molesta lo rutinario y repetitivo, prefiero lo distinto y único.</strong></h3></center><br>
