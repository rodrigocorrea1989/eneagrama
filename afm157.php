...
<div class="card">
  <div class="card-body">
    ...
    <center><span>157 de 270</span></center><br>
<form action="afm158.php" method="POST">
    <center><h3 class="text-dark"><strong>Si los demás fueran tan lógicos y objetivos como yo, la vida sería más interesante.</strong></h3></center><br>
