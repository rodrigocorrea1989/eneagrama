...
<div class="card">
  <div class="card-body">
    ...
    <center><span>94 de 270</span></center><br>
<form action="afm95.php" method="POST">
    <center><h3 class="text-dark"><strong>Para mí es más importante disfrutar de la seguridad que desarrollar mis propios intereses.</strong></h3></center><br>
