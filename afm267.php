...
<div class="card">
  <div class="card-body">
    ...
    <center><span>267 de 270</span></center><br>
<form action="afm268.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta crear, soñar, vibrar la vida.</strong></h3></center><br>
