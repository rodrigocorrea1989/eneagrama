...
<div class="card">
  <div class="card-body">
    ...
    <center><span>46 de 270</span></center><br>
<form action="afm47.php" method="POST">
    <center><h3 class="text-dark"><strong>Se puede decir que soy una persona afectuosa, perceptiva, generosa, empática, atenta.</strong></h3></center><br>
