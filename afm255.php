...
<div class="card">
  <div class="card-body">
    ...
    <center><span>255 de 270</span></center><br>
<form action="afm256.php" method="POST">
    <center><h3 class="text-dark"><strong>No hay libertad sin responsabilidad.</strong></h3></center><br>
