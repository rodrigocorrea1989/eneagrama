...
<div class="card">
  <div class="card-body">
    ...
    <center><span>139 de 270</span></center><br>
<form action="afm140.php" method="POST">
    <center><h3 class="text-dark"><strong>Observo y analizo la realidad para entenderla.</strong></h3></center><br>
