...
<div class="card">
  <div class="card-body">
    ...
    <center><span>231 de 270</span></center><br>
<form action="afm232.php" method="POST">
    <center><h3 class="text-dark"><strong>La armonía y la aceptación son valores importantes para mí.</strong></h3></center><br>
