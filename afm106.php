...
<div class="card">
  <div class="card-body">
    ...
    <center><span>106 de 270</span></center><br>
<form action="afm107.php" method="POST">
    <center><h3 class="text-dark"><strong>Tiendo a cuidar los detalles, el orden y la precisión.</strong></h3></center><br>
