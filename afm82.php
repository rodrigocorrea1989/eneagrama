...
<div class="card">
  <div class="card-body">
    ...
    <center><span>82 de 270</span></center><br>
<form action="afm83.php" method="POST">
    <center><h3 class="text-dark"><strong>Necesito gran cantidad de espacio y de tiempos privados para estudiar y reflexionar.</strong></h3></center><br>
