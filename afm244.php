...
<div class="card">
  <div class="card-body">
    ...
    <center><span>244 de 270</span></center><br>
<form action="afm245.php" method="POST">
    <center><h3 class="text-dark"><strong>Soy una persona buena para persuadir y movilizar a los demás.</strong></h3></center><br>
