...
<div class="card">
  <div class="card-body">
    ...
    <center><span>204 de 270</span></center><br>
<form action="afm205.php" method="POST">
    <center><h3 class="text-dark"><strong>El tiempo es de cada uno, me molesta que la gente no cumpla estrictamente los horarios comprometidos.</strong></h3></center><br>
