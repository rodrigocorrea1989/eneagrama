...
<div class="card">
  <div class="card-body">
    ...
    <center><span>44 de 270</span></center><br>
<form action="afm45.php" method="POST">
    <center><h3 class="text-dark"><strong>En general, prefiero estar dentro del desarrollo de una operación que observar como marcha.</strong></h3></center><br>
