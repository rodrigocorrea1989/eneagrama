...
<div class="card">
  <div class="card-body">
    ...
    <center><span>108 de 270</span></center><br>
<form action="afm109.php" method="POST">
    <center><h3 class="text-dark"><strong>A veces soy complaciente, aunque piensen que no me juego por una posición.</strong></h3></center><br>
