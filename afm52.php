...
<div class="card">
  <div class="card-body">
    ...
    <center><span>52 de 270</span></center><br>
<form action="afm53.php" method="POST">
    <center><h3 class="text-dark"><strong>Soy una persona permisiva conmigo misma, hay pocas cosas que no disfrute.</strong></h3></center><br>
