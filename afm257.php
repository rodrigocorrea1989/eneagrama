...
<div class="card">
  <div class="card-body">
    ...
    <center><span>257 de 270</span></center><br>
<form action="afm258.php" method="POST">
    <center><h3 class="text-dark"><strong>Me precio de ser una persona estable.</strong></h3></center><br>
