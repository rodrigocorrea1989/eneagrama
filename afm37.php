...
<div class="card">
  <div class="card-body">
    ...
    <center><span>37 de 270</span></center><br>
<form action="afm38.php" method="POST">
    <center><h3 class="text-dark"><strong>Me gusta crear cosas nuevas y obtener reconocimiento por mi originalidad, aunque tenga que superarme permanentemente.</strong></h3></center><br>
