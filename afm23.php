...
<div class="card">
  <div class="card-body">
    ...
    <center><span>23 de 270</span></center><br>
<form action="afm24.php" method="POST">
    <center><h3 class="text-dark"><strong>Me cuesta mucho contar historias sin exagerar un poquito o ponerle algún toque gracioso para captar la atención.</strong></h3></center><br>
