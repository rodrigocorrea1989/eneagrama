...
<div class="card">
  <div class="card-body">
    ...
    <center><span>16 de 270</span></center><br>
<form action="afm17.php" method="POST">
    <center><h3 class="text-dark"><strong>Con frecuencia las dudas me invaden.</strong></h3></center><br>
