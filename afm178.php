...
<div class="card">
  <div class="card-body">
    ...
    <center><span>178 de 270</span></center><br>
<form action="afm179.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelen acusarme de ser una persona competitiva, vanidosa, narcisista.</strong></h3></center><br>
