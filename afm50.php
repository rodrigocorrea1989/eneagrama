...
<div class="card">
  <div class="card-body">
    ...
    <center><span>50 de 270</span></center><br>
<form action="afm51.php" method="POST">
    <center><h3 class="text-dark"><strong>Me molesta el fracaso, eso es para los débiles.</strong></h3></center><br>
