...
<div class="card">
  <div class="card-body">
    ...
    <center><span>247 de 270</span></center><br>
<form action="afm248.php" method="POST">
    <center><h3 class="text-dark"><strong>Suelen acusarme de ser una pesrona distante, arrogante, desvalorizadora.</strong></h3></center><br>
