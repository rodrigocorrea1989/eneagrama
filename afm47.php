...
<div class="card">
  <div class="card-body">
    ...
    <center><span>47 de 270</span></center><br>
<form action="afm48.php" method="POST">
    <center><h3 class="text-dark"><strong>Me fastidian las personas que no son lógicas.</strong></h3></center><br>
