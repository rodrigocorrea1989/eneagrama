...
<div class="card">
  <div class="card-body">
    ...
    <center><span>198 de 270</span></center><br>
<form action="afm199.php" method="POST">
    <center><h3 class="text-dark"><strong>Con frecuencia el parecer de los demás no me interesa.</strong></h3></center><br>
