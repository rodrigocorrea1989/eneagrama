...
<div class="card">
  <div class="card-body">
    ...
    <center><span>148 de 270</span></center><br>
<form action="afm149.php" method="POST">
    <center><h3 class="text-dark"><strong>Si tengo que elegir entre algo nuevo y algo conocido, tiendo a escoger lo nuevo.</strong></h3></center><br>
